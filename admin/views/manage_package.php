...
<div class="row" STYLE="POSITION: relative; TOP: 30px;">
       ...
       <tr>
         ...
         <button id="<?php echo $row['id'];?>" type="button" class="btn btn-primary btnEditPackage" data-toggle="modal"  data-target="#editPackage">
                ...
                <br>
                <button  data-id="<?php echo $row['id'];?>"  onclick="confirm('Are you sure you want to delete this package')" style="padding:10px;text-decoration:none; background:red; color:white; border-radius:6px; font-size:12px; font-weight:bold" id="btnDelete">Delete</a>
         </td>
         <td> 

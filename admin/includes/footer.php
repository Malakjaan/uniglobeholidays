...
e.preventDefault();
var id = $('#btnEditPackage').attr("data-id");
...
$.ajax({
    ...
    success:function(data){
        if(data == 200) {
            ...
            alert('Failed to delete details. Please try again later');
            window.location.href = window.location.href
        }
    }
});
        ...
        $('.btnEditSlider').on('click', function(){
            //var id = $('.btneditslider').attr("data-id");
            var id = $(this).attr("id");  
        ...
        $('#btnDelete').on('click', function(e){
            ...
            $.ajax({
                url:'../routes/delete_slider.php',
                method: 'post',
                data: {slider_id: id},                
                success:function(data){
                    if(data == 200) {
                        alert('Slider Details Deleted Successfully');
                        window.location.href = window.location.href
                    } else {
                        alert('Failed to delete details. Please try again later');
                        window.location.href = window.location.href
